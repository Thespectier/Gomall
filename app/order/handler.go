...
// ModifyOrder implements the OrderServiceImpl interface.
func (s *OrderServiceImpl) ModifyOrder(ctx context.Context, req *order.ModifyOrderReq) (resp *order.ModifyOrderResp, err error) {
	resp, err = service.NewModifyOrderService(ctx).Run(req)
