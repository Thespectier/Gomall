...
type RPCClient interface {
	...
	ModifyOrder(ctx context.Context, Req *order.ModifyOrderReq, callOptions ...callopt.Option) (r *order.ModifyOrderResp, err error)
...
func (c *clientImpl) ModifyOrder(ctx context.Context, Req *order.ModifyOrderReq, callOptions ...callopt.Option) (r *order.ModifyOrderResp, err error) {
	return c.kitexClient.ModifyOrder(ctx, Req, callOptions...)
}
