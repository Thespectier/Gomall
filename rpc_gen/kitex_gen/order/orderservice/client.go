...
func (p *kOrderServiceClient) ModifyOrder(ctx context.Context, Req *order.ModifyOrderReq, callOptions ...callopt.Option) (r *order.ModifyOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ModifyOrder(ctx, Req)
}
