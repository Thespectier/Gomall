...
func (x *Order) fastReadField8(buf []byte, _type int8) (offset int, err error) {
	x.PaidAt, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}
...
func (x *Order) fastReadField10(buf []byte, _type int8) (offset int, err error) {
	x.AutocancelAt, offset, err = fastpb.ReadInt64(buf, _type)
	return offset, err
}
...
func (x *ModifyOrderReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ModifyOrderReq[number], err)
}

func (x *ModifyOrderReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *ModifyOrderReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ModifyOrderReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.UserCurrency, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ModifyOrderReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	var v Address
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *ModifyOrderReq) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.Email, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ModifyOrderReq) fastReadField6(buf []byte, _type int8) (offset int, err error) {
	var v OrderItem
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *ModifyOrderResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ModifyOrderResp[number], err)
}

func (x *ModifyOrderResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.OrderId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *Order) fastWriteField8(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 8, x.GetPaidAt())
	return offset
}
...
func (x *Order) fastWriteField9(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 9, x.GetUpdatedAt())
	return offset
}
...
func (x *Order) fastWriteField10(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 10, x.GetAutocancelAt())
	return offset
}
...
func (x *ModifyOrderReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ModifyOrderReq) fastWriteField1(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 1, x.GetUserId())
...
func (x *ModifyOrderReq) fastWriteField2(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
...
func (x *ModifyOrderReq) fastWriteField3(buf []byte) (offset int) {
	if x.UserCurrency == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 3, x.GetUserCurrency())
...
func (x *ModifyOrderReq) fastWriteField4(buf []byte) (offset int) {
	if x.Address == nil {
		return offset
	}
...
func (x *ModifyOrderReq) fastWriteField5(buf []byte) (offset int) {
	if x.Email == "" {
		return offset
	}
...
func (x *ModifyOrderReq) fastWriteField6(buf []byte) (offset int) {
	if x.OrderItems == nil {
		return offset
	}
	for i := range x.GetOrderItems() {
...
func (x *ModifyOrderResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ModifyOrderResp) fastWriteField1(buf []byte) (offset int) {
	if x.OrderId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetOrderId())
...
func (x *Order) sizeField8() (n int) {
	...
	n += fastpb.SizeInt64(8, x.GetPaidAt())
	return n
}
...
func (x *Order) sizeField9() (n int) {
	...
	n += fastpb.SizeInt64(9, x.GetUpdatedAt())
	return n
}
...
func (x *Order) sizeField10() (n int) {
	...
	n += fastpb.SizeInt64(10, x.GetAutocancelAt())
	return n
}
...
func (x *ModifyOrderReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ModifyOrderReq) sizeField1() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeUint32(1, x.GetUserId())
...
func (x *ModifyOrderReq) sizeField2() (n int) {
	if x.OrderId == "" {
		return n
	}
...
func (x *ModifyOrderReq) sizeField3() (n int) {
	if x.UserCurrency == "" {
		return n
	}
	n += fastpb.SizeString(3, x.GetUserCurrency())
...
func (x *ModifyOrderReq) sizeField4() (n int) {
	if x.Address == nil {
		return n
	}
...
func (x *ModifyOrderReq) sizeField5() (n int) {
	if x.Email == "" {
		return n
	}
...
func (x *ModifyOrderReq) sizeField6() (n int) {
	if x.OrderItems == nil {
		return n
	}
	for i := range x.GetOrderItems() {
...
func (x *ModifyOrderResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ModifyOrderResp) sizeField1() (n int) {
	if x.OrderId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetOrderId())
...
var fieldIDToName_ModifyOrderReq = map[int32]string{
	1: "UserId",
	2: "OrderId",
	3: "UserCurrency",
	4: "Address",
...
var fieldIDToName_ModifyOrderResp = map[int32]string{
	1: "OrderId",
}
